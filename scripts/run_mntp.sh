...
srun --cpu-bind=none python3 /lustre/mlnvme/data/the_tucanos/llm2vec/experiments/run_mntp.py \
/lustre/mlnvme/data/the_tucanos/llm2vec/train_configs/mntp/tucano-mntb.json 1>$out 2>$err
