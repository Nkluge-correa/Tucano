...
srun --cpu-bind=none python3 /lustre/mlnvme/data/the_tucanos/Tucano/sft-tucano.py \
 --specs "/lustre/mlnvme/data/the_tucanos/Tucano/specs-tucano-sft.yml" \
